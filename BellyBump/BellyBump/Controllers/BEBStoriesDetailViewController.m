...
- (void)genderEditViewRefresh:(BEBGenderType) genderParam
{
    if (self.story.gender == GenderBoy) {
        self.headerView.genderLabel.text = @"It's a boy!";
    }
    else if (self.story.gender == GenderGirl) {
        self.headerView.genderLabel.text = @"It's a girl!";
    }
    else {
        self.headerView.genderLabel.text = @"It's a suprise!";
    }
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (kind == UICollectionElementKindSectionHeader) {
        ...
        if (self.story.gender == GenderBoy) {
            headerView.genderLabel.text = @"It's a boy!";
        }
        else if (self.story.gender == GenderGirl) {
            headerView.genderLabel.text = @"It's a girl!";
        }
        else {
            headerView.genderLabel.text = @"It's a suprise!";
        }
